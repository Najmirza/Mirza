! function(t, e) {
    ...
    var i = function(t, e) {
        ...
        h = function(t, e) {
            g(t, "sizes", i(t, e.data_sizes)), g(t, "srcset", i(t, e.data_srcset)), g(t, "src", i(t, e.data_src))
        },
        m = {
            IMG: function(t, e) {
                var n = t.parentNode;
            ...
            IFRAME: function(t, e) {
                g(t, "src", i(t, e.data_src))
            },
            VIDEO: function(t, e) {
                v(t).forEach((function(t) {
                    g(t, "src", i(t, e.data_src))
                })), g(t, "poster", i(t, e.data_poster)), g(t, "src", i(t, e.data_src)), t.load()
            }
        },
        b = function(t, e) {
            var n, r, a = e._settings,
                o = t.tagName,
                s = m[o];
            if (s) return s(t, a), _(e, 1), void(e._elements = (n = e._elements, r = t, n.filter((function(t) {
                return t !== r
            }))));
            ! function(t, e) {
        ...
        k = function(t, e, n) {
            var r = n._settings,
                ...
                s = t.target;
            y(s, r.class_loading), p(s, a), f(o, s, n), _(n, -1)
        },
        A = function(t, e) {
            var n = function n(a) {
                    k(a, !0, e), I(t, n, r)
        ...
        x = function(t, e, n) {
            var r = e._settings;
            !n && l(t) || (L.indexOf(t.tagName) > -1 && (A(t, e), p(t, r.class_loading)), b(t, e), function(t) {
                c(t, "was-processed", "true")
            }(t), f(r.callback_reveal, t, e))
        },
        C = function(t) {
            return !!r && (t._observer = new IntersectionObserver((function(e) {
                e.forEach((function(e) {
                    return function(t) {
                        ...
                        var r = n._settings;
                        f(r.callback_enter, t, e, n), r.load_delay ? N(t, n) : z(t, n)
                    }(e.target, e, t) : function(t, e, n) {
                        var r = n._settings;
                        f(r.callback_exit, t, e, n), r.load_delay && O(t)
                    }(e.target, e, t)
                }))
            }), {
    ...
    return j.prototype = {
        update: function(t) {
            ...
            (this._elements = R(t, a), !n && this._observer) ? (function(t) {
                ...
                -1 !== M.indexOf(t.tagName) && (t.setAttribute("loading", "lazy"), x(t, e))
